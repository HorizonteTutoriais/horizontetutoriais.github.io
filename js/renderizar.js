...
(function() {
    ...
    function gerarTutorialAutomatico(item) {
        if (item.tutorialTitulo) return item;
    ...
    function criarCard(item, prefixo) {
        ...
        if (item.categoria === 'Ferramentas' && item.especificacoes) {
            ...
            specsHTML += `<tr><td style="padding:6px; font-weight:700; color:#555; border-bottom:1px solid #f5f5f5;">Versão</td><td style="padding:6px; color:#666; border-bottom:1px solid #f5f5f5; text-align:right;">${s.versao}</td></tr>`;
            specsHTML += `<tr><td style="padding:6px; font-weight:700; color:#555; border-bottom:1px solid #f5f5f5;">Tamanho</td><td style="padding:6px; color:#666; border-bottom:1px solid #f5f5f5; text-align:right;">${s.tamanho}</td></tr>`;
    ...
    window.renderizarTudo = function() {
        ...
        if (path.includes('/pages/tutoriais.html')) {
            const tutsContainer = document.querySelector('.popular-section');
            if (tutsContainer) {
