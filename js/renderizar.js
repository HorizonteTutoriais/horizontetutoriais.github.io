    ...
    window.renderizarTudo = function() {
        ...
        if (urlId) {
            ...
            if (postItem) {
                ...
                // Renderizar botão de tutorial, ferramenta e YouTube logo abaixo
                ...
                if (tutorialsWidget) {
                    tutorialsWidget.innerHTML = `
                        ...
                        <a href="https://www.youtube.com/@HorizonteTutoriais" class="btn-tutorial-direct" style="background: #ff0000; margin-top: 10px; display: flex; flex-direction: column; padding: 15px 10px; height: auto; text-align: center; justify-content: center;" target="_blank" rel="noopener">
                            <span style="font-size: 13px; font-weight: 800; margin-bottom: 4px;"><i class="fab fa-youtube"></i> CANAL HORIZONTE TUTORIAIS</span>
                            <span style="font-size: 10px; font-weight: 400; opacity: 0.9;">INSCREVA-SE E ATIVE O SINO DE NOTIFICAÇÕES</span>
                        </a>
                    `;
                }
