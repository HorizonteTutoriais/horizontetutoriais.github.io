        ...
        if (path.includes('/posts/')) {
            ...
            if (postItem) {
                ...
                if (infoTable) {
                    ...
                    // Botão de Feed LARANJA com botão de Tutorial INTEGRADO
                    feedContainer.innerHTML = `
                        <div style="background: #f57c00; border-radius: 6px; padding: 10px; display: flex; flex-direction: column; gap: 8px;">
                ...
                // Remover qualquer link ou botão de Feed que esteja sobrando na área central
                const centerFeedBtns = document.querySelectorAll('.post-content .rss-copy-btn');
                centerFeedBtns.forEach(btn => {
                    if (!btn.closest('.info-table') && !btn.closest('.modal-content')) {
